{**************************************************************************************************
 This file is part of the Eye Candy Controls (EC-C)
  ...
  Copyright (C) 2014-2018  Vojtěch Čihák, Czech Republic
...
begin
  ...
  if AEnabled then
    for aIState:=eisHighlighted to eisPushedHilighted do
...
const caElements: array [low(TItemState)..high(TItemState)] of TThemedButton = 
  (tbRadioButtonUncheckedDisabled, tbRadioButtonUncheckedHot, tbRadioButtonUncheckedNormal,
   tbRadioButtonCheckedNormal, tbRadioButtonCheckedNormal, tbRadioButtonCheckedHot,
...
const caElements: array [low(TItemState)..high(TItemState)] of TThemedButton = 
  (tbCheckBoxUncheckedDisabled, tbCheckBoxUncheckedHot, tbCheckBoxUncheckedNormal,
   tbCheckBoxCheckedNormal, tbCheckBoxCheckedNormal, tbCheckBoxCheckedHot,
